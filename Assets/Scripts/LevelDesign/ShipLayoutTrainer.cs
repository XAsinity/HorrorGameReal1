...
public class ShipLayoutTrainer : MonoBehaviour
{
    ...
    private const int GENOME_LEN = 22;
    ...
    private void ApplyGenome(float[] g)
    {
        ...
        // For now, apply the mid-point of each range as the fixed value.
        // When ShipLayoutGenerator gains trainedParams support, we pass p directly instead.
